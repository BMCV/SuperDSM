...
def cvxprog(region, scale, epsilon, alpha, smooth_amount, smooth_subsample, gaussian_shape_multiplier, smooth_mat_allocation_lock, smooth_mat_dtype, hessian_sparsity_tol=0, init=None, cachesize=0, cachetest=None, cp_timeout=None):
    ...
    J = Energy(region, epsilon, alpha, smooth_matrix_factory, hessian_sparsity_tol)
