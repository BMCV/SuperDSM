...
class GenerationStage(gocell.pipeline.Stage):
    ...
    def process(self, input_data, cfg, out, log_root_dir):
        ...
        while True:
            ...
            new_generation = _iterate_generation(cover, generations[-1], y_surface, g_atoms, adjacencies, modelfit_kwargs, _get_generation_log_dir(log_root_dir, generation_number), conservative, out)
...
def _iterate_generation(cover, previous_generation, y, g_atoms, adjacencies, modelfit_kwargs, log_root_dir, conservative, out):
